...
<head>
 ...
 <![endif]-->
    ...
    <!--<![endif]-->
    <title>Email - Lyceum Campus</title>
    <!--[if gte mso 9]>
                            ...
                            <table width="650" border="0" cellspacing="0" cellpadding="0" class="m-shell">
                                <tr>
                                    <td class="td"
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                            bgcolor="#ffffff" style="border-radius: 6px 6px 0px 0px; padding-top:2rem">
                                            <tr></tr>
                                        </table>
                                                ...
                                                <tr>
                                                    <td style="padding: 0px 40px 40px 40px;" class="p0-15-30">
                                                        <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td class="h3 center"
                                                                    style="padding-bottom: 30px; color:#444444; font-family:'Yantramanav', Arial, sans-serif; font-size:28px; line-height:37px; font-weight:300; text-align:center;">
                                                                    {{ $title }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text center"
                                                                    style="padding-bottom: 26px; color:#666666; font-family:Arial, sans-serif; font-size:16px; line-height:30px; min-width:auto !important; text-align:center;">
                                                                    <div>
                                                                        <p>Hi {{ $friendName }},</p>

                                                                        <p>You have been invited to join
                                                                            {{ $userName }}'s friend list.
                                                                            Click the link below to accept the
                                                                            invitation:</p>

                                                                        <p><a
                                                                                href="{{ $invitationUrl }}">{{ $invitationUrl }}</a>
                                                                        </p>
